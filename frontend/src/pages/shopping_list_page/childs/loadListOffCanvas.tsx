...
const LoadListOffCanvas = (props: any) => {
  ...
  return (
    <MainOffCanvas show={props.show} handleClose={props.handleClose}>
      <div>
        ...
        <div className='fontStyle' style={{marginBottom: '5px'}}>Load lists.</div>
        ...
        <div style={{marginTop: '10px'}}>
          <MainButton buttonText={"Load list"} handleClick={() => {
            props.loadList(selectedItem)
            props.handleClose()
          }}></MainButton>
        </div>
      </div>
...
export default LoadListOffCanvas